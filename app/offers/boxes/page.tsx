...
const BOXES = [
  { slug: "tech-starter-box", title: "Tech Starter Box", emoji: "💻", value: "$199", price: "$89", keyword: "bluetooth earbuds", items: 5 },
  { slug: "beauty-box", title: "Beauty Glow Box", emoji: "💄", value: "$120", price: "$55", keyword: "makeup kit", items: 6 },
  { slug: "home-box", title: "Smart Home Box", emoji: "🏠", value: "$250", price: "$99", keyword: "smart led bulb", items: 4 },
  { slug: "fitness-box", title: "Fitness Pro Box", emoji: "🏋️", value: "$180", price: "$75", keyword: "fitness tracker", items: 6 },
  { slug: "kitchen-box", title: "Kitchen Essential Box", emoji: "🍳", value: "$150", price: "$65", keyword: "coffee frother", items: 5 },
  { slug: "outdoor-box", title: "Outdoor Adventure Box", emoji: "🏕️", value: "$220", price: "$95", keyword: "camping lantern", items: 7 },
];
