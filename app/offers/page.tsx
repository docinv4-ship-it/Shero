...
const OFFER_COLLECTIONS = [
  { slug: "tech-bundle", title: "Tech Starter Bundle", icon: "💻", desc: "Premium gadgets & desktop accessories", keyword: "mechanical keyboard", color: "from-blue-500 to-purple-600" },
  { slug: "home-essentials", title: "Home Essentials Pack", icon: "🏠", desc: "Must-haves for every modern home", keyword: "room humidifier", color: "from-orange-500 to-red-500" },
  { slug: "beauty-kit", title: "Beauty & Skincare Kit", icon: "✨", desc: "Top-rated premium beauty products", keyword: "skincare set", color: "from-pink-500 to-rose-500" },
  { slug: "fitness-set", title: "Fitness Starter Set", icon: "💪", desc: "Get fit with top-tier premium gear", keyword: "dumbbells", color: "from-green-500 to-teal-600" },
  { slug: "office-kit", title: "Work From Home Kit", icon: "🖥️", desc: "Productivity & desk setups essentials", keyword: "desk pad", color: "from-gray-600 to-gray-800" },
  { slug: "travel-gear", title: "Travel Essentials", icon: "✈️", desc: "Premium luggage and packing setups", keyword: "packing cubes", color: "from-sky-500 to-blue-600" },
];
...
async function FeaturedOfferProducts({ keyword }: { keyword: string }) {
  ...
  if (!result || !result.products || !result.products.length) return null;
