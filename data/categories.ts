...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    name: "Toys & Novelties",
    icon: "🧸",
    description: "RC drones, action figures, custom models, educational puzzles",
    keywords: "toys novelties",
    color: "bg-fuchsia-500",
    subcategories: [
      { name: "RC & Drones", keywords: "RC car remote control helicopter drone quadcopter toy", slug: "rc-toys" },
      { name: "Action Figures", keywords: "action figure anime statues collectible model toy", slug: "action-figures" },
      { name: "Puzzles & Games", keywords: "educational board game building blocks puzzle bricks", slug: "educational-games" },
      { name: "Novelty & Adult", keywords: "adult sex toys vibrator massager couples novelty products", slug: "adult-novelty" },
      { name: "Plush & Dolls", keywords: "plush toy stuffed animal soft doll plushie", slug: "plush-dolls" },
    ],
  },
];
